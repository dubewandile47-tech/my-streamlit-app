...
feature = st.selectbox(
    ...
    ["1. CV & Cover Letter - Protocol 4", "2. WhatsApp Reply Writer - Protocol 1",
     "3. Scam Checker - Protocol 2", "4. Business Ideas - Protocol 3", "5. Ask JARVIS Anything - Protocol 5"]
)

protocol_key = feature.split("- ")[1]
